...
const intro = ["UNICEF에 따르면 3억 5천 6백만명의 어린이들이 하루에 1.9달러 미만으로 거주하고 있다고 해요.", "WHO에 따르면 저소득 국가 6명 중 1명은 초등교육을 미수한다고 해요."];
const explanation = ["어린이를 직접 양육하는 기관을 설립하기 위한 기금을 조성합니다. 주로 건강검진, 전문 인력 양성, 시설비에 사용됩니다.", "어린이가 꿈을 이룰 수 있도록 특별 교육을 지원합니다. 주로 직업 교육, 문맹 퇴치, 학용품 지원에 사용됩니다."];
