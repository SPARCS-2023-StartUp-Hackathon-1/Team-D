...
function checkEventState(eventDate: Date) {
  ...
  const millisec_per_day =
    HOURS_OF_DAY * MINUTES_OF_HOUR * SECONDS_OF_MINUTE * MILLISEC_OF_SEC;
...
export const eventRouter = createTRPCRouter({
  ...
  getAllEventsByUserId: protectedProcedure.query(async ({ ctx }) => {
